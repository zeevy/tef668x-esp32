/**
 * @file encoder.h
 * @brief The rotary encoder and the panel buttons, as pins.
 *
 ...
 *
 * @return Clicks. Positive is clockwise, unless the encoder is reversed.
 */
 ...
 *
 * @param button  Which one.
 * @return true when it is pressed.
 */
bool encoderButtonDown(PanelButton button);

/**
 * The button's name, for a log line or a diagnostic page.
 *
 * @param button  Which one.
 * @return A short upper case name. Never NULL.
 */
